import { $decoder, $deleteByIndex, $onEncodeEnd, $encoder, $filter, $getByIndex, $onDecodeEnd } from "../symbols";
import { OPERATION } from "../../encoding/spec";
import { Collection } from "../HelperTypes";
import type { StateView } from "../../encoder/StateView";
export declare class ArraySchema<V = any> implements Array<V>, Collection<number, V> {
    [n: number]: V;
    protected items: V[];
